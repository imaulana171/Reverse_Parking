...
onnx_model_path = 'Model/CustomYOLOv5n.onnx'
...
def process_frame(img):
    global detection_results, detection_buffer, slot_numbers
    ...
    for i, pos in enumerate(posList):
            ...
            if car_x < x + 20 and car_x + car_w > x and car_y < y + 30 and car_y + car_h > y:
                ...
                if j < len(classes_ids):  # Pastikan indeks berada dalam rentang
                    ...
                    if classes_ids[j] == 1:
                        ...
                        color = (0, 255, 0)
                        thickness = 3
                        if slot_number in frame_slot_numbers:
                            frame_slot_numbers.remove(slot_number)
                found = True
                break
        ...
        cv2.rectangle(img, pos, (pos[0] + 20, pos[1] + 30), color, thickness)
